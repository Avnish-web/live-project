document.addEventListener("DOMContentLoaded", function () {
    ...
    if (monthBtn && yearBtn && priceBusiness) {
        monthBtn.addEventListener("click", () => {
            priceBusiness.innerHTML =
                '₹499<span class="fs-6 fw-normal">/mo</span>';
        ...
        yearBtn.addEventListener("click", () => {
            priceBusiness.innerHTML =
                '₹409<span class="fs-6 fw-normal">/mo</span> <span class="text-success fs-6 fw-normal">(billed yearly)</span>';
